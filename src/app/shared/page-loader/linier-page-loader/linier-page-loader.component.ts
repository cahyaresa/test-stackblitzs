...
@Component({
  selector: 'app-linier-page-loader',
  templateUrl: './linier-page-loader.component.html',
  styleUrls: ['./linier-page-loader.component.scss']
})
export class LinierPageLoaderComponent implements OnInit {

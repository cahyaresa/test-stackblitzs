...
import { Product, ProductScope, ProductService, FeatureConfigService } from '@spartacus/core';
import { SwiperConfigInterface, SwiperPaginationInterface } from 'ngx-swiper-wrapper';
import { BreakpointService, BREAKPOINT } from '@spartacus/storefront';
import { map } from 'rxjs/operators';

@Component({
  selector: 'app-mkt-product-carousel',
  templateUrl: './mkt-product-carousel.component.html',
  styleUrls: ['./mkt-product-carousel.component.scss']
})
export class MktProductCarouselComponent implements OnInit, OnDestroy {
